...
int main() { 
    ...
    do {
        printf("Enter a 9-bit color value (0 to 511) as a hexadecimal number (e.g., 0x1FF for white):\n> ");
        ...
        // Call the conversion function with user input
        convert_9bit_to_24bit(color_9bit);
