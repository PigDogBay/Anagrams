...
spriteData:
    ...
    ;Tile sprites
    spriteItem 1,90,  TITLE_Y,  TILE_PALETTE_OFFSET,'D'-Tile.ASCII_PATTERN_OFFSET,1,0
    spriteItem 2,110, TITLE_Y,  TILE_PALETTE_OFFSET,'R'-Tile.ASCII_PATTERN_OFFSET,2,0
    spriteItem 3,130, TITLE_Y,  TILE_PALETTE_OFFSET,'O'-Tile.ASCII_PATTERN_OFFSET,3,0
    spriteItem 4,150, TITLE_Y,  TILE_PALETTE_OFFSET,'P'-Tile.ASCII_PATTERN_OFFSET,4,0
    spriteItem 5,170, TITLE_Y,  TILE_PALETTE_OFFSET,'P'-Tile.ASCII_PATTERN_OFFSET,5,0
    spriteItem 6,190, TITLE_Y,  TILE_PALETTE_OFFSET,'E'-Tile.ASCII_PATTERN_OFFSET,6,0
    spriteItem 7,210, TITLE_Y,  TILE_PALETTE_OFFSET,'D'-Tile.ASCII_PATTERN_OFFSET,7,0
    spriteItem 8,130, TITLE_Y2, TILE_PALETTE_OFFSET,'O'-Tile.ASCII_PATTERN_OFFSET,8,0
    spriteItem 9,150, TITLE_Y2, TILE_PALETTE_OFFSET,'U'-Tile.ASCII_PATTERN_OFFSET,9,0
    spriteItem 10,170,TITLE_Y2, TILE_PALETTE_OFFSET,'T'-Tile.ASCII_PATTERN_OFFSET,10,0
