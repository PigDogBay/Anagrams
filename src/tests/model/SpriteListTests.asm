...
UT_restoreAllInteraction1:
    COPY_DATA .dataLen, .data
    call SpriteList.removeAllInteraction
    call SpriteList.restoreAllInteraction

    TEST_MEMORY_BYTE SpriteList.list + spriteItem + spriteItem.flags,MouseDriver.MASK_HOVERABLE
    TEST_MEMORY_BYTE SpriteList.list + spriteItem*2 + spriteItem.flags,(MouseDriver.MASK_HOVERABLE| MouseDriver.MASK_DRAGABLE)
    TEST_MEMORY_BYTE SpriteList.list + spriteItem*3 + spriteItem.flags,(MouseDriver.MASK_HOVERABLE| MouseDriver.MASK_CLICKABLE)
